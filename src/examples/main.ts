...
async function main() : Promise<void> {
  ...
  const settings: FiscalapiSettings = {
    ...
    debug:true // true=Muestra raw http request y response en la consola
  };
  ...
  try {
    ...
    //   date: DateTime.now().toFormat("yyyy-MM-dd'T'HH:mm:ss"), // Formato de fecha actual
    //   currencyCode: "XXX", // Para complementos de pago siempre es XXX
    //   typeCode: "P", // Tipo P para complementos de pago
    //   expeditionZipCode: "01160",
    //   exchangeRate: 1, // Para complementos de pago siempre es 1
    ...
    //     taxCredentials: [
    //       {
    //         base64File: base64Cert, // Asumiendo que base64Cert ya está definido
    //         fileType: 0,
    //         password: "12345678a"
    //       },
    //       {
    //         base64File: base64Key, // Asumiendo que base64Key ya está definido
    //         fileType: 1,
    //         password: "12345678a"
    //       }
    //     ]
    ...
    //   taxCredentials: [
    //     {
    //       base64File: base64Cert, // Utiliza la constante base64Cert ya definida
    //       fileType: 0,
    //       password: "12345678a"
    //     },
    //     {
    //       base64File: base64Key, // Utiliza la constante base64Key ya definida
    //       fileType: 1,
    //       password: "12345678a"
    //     }
    //   ]
    ...
    // const apiResponse = await client.invoices.cancel(cancelInvoice);
    // console.log('apiResponse:', apiResponse);
    ...
    // const apiResponse = await client.invoices.getStatus(invoiceStatus);
    // console.log('apiResponse:', apiResponse);
    ...
    // const apiResponse = await client.invoices.getPdf(invoicePdf);
    // console.log('apiResponse:', apiResponse);
    ...
    // const apiResponse = await client.invoices.getXml("fc2bb1aa-12a7-4d92-bdea-57d589bd29d6");
    // console.log('apiResponse:', apiResponse);
